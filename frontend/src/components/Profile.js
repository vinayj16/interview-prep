...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaLinkedin, FaGithub, FaEdit, FaSave, FaTimes, FaChartLine, FaTrophy, FaFire, FaCalendarAlt, FaCode, FaGraduationCap, FaStar, FaUserCircle, FaCheck } from 'react-icons/fa';
...
const Profile = () => {
          ...
          <div className="login-section">
            <div className="login-card">
              ...
              <div className="login-actions">
                ...
                <button className="btn btn-secondary" onClick={() => window.location.href = '/register'}>Sign Up</button>
              </div>
              <p className="login-note">
                No account? All features are available without login, but you can save your progress by signing up!
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="profile-page" data-theme={state.theme} role="main" aria-label="Profile main content">
      {state.user ? (
        <>
              ...
              <div className="stats-grid">
                <div className="stat-card">
                  ...
                  <div className="stat-info">
                    <h3>{state.stats.codingProblems}</h3>
      ...
      {/* Profile Details */}
        ...
        <div className="login-section">
          <div className="login-card">
            ...
            <p>Access your stats, progress, and personalized recommendations.</p>
            <div className="login-features">
              <div className="feature-item">
                <FaCheck /> Track your progress
              </div>
              <div className="feature-item">
                <FaCheck /> Save your favorite questions
              </div>
              <div className="feature-item">
                <FaCheck /> Get personalized analytics
              </div>
            </div>
            <div className="login-note">No account? All features are available without login!</div>
          </div>
        </div>
      )}
    </div>
